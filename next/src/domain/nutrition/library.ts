...
// Generic food-composition references per 100 g. When a packaged product differs,
// the product label should take precedence. Cooked/raw state is explicit in the name.
...
export const CORE_RECIPES: RecipeDefinition[] = [
  {
    ...
    ingredients: [
      { ingredientId: 'oats', grams: 55 }, { ingredientId: 'egg', grams: 60 }, { ingredientId: 'eggwhite', grams: 150 },
      { ingredientId: 'banana', grams: 80 }, { ingredientId: 'chia', grams: 10 },
    ],
    steps: ['Tritura o mezcla todos los ingredientes.', 'Cocina en microondas o airfryer hasta que el centro quede cuajado.', 'Deja reposar un minuto antes de comer.'],
  },
  {
    id: 'skyr-bowl', name: 'Skyr con avena, chía y frutos rojos', servings: 1, prepMinutes: 4,
    ingredients: [
      { ingredientId: 'skyr', grams: 250 }, { ingredientId: 'oats', grams: 35 }, { ingredientId: 'berries', grams: 120 }, { ingredientId: 'chia', grams: 10 },
    ],
  ...
  },
  {
    ...
    ingredients: [
      { ingredientId: 'greek0', grams: 250 }, { ingredientId: 'apple', grams: 160 }, { ingredientId: 'almonds', grams: 18 },
    ],
    steps: ['Trocea la fruta.', 'Mezcla con el yogur.', 'Añade las almendras al servir.'],
  },
  {
    id: 'cottage-toast', name: 'Tostadas con cottage y tomate', servings: 1, prepMinutes: 7,
    ingredients: [
      { ingredientId: 'bread', grams: 90 }, { ingredientId: 'cottage', grams: 180 }, { ingredientId: 'tomato', grams: 150 }, { ingredientId: 'oliveoil', grams: 5 },
    ],
  ...
  },
  {
    ...
    ingredients: [
      { ingredientId: 'chicken', grams: 170 }, { ingredientId: 'rice', grams: 240 }, { ingredientId: 'broccoli', grams: 180 }, { ingredientId: 'oliveoil', grams: 10 },
    ],
  ...
  },
  {
    ...
    ingredients: [
      { ingredientId: 'chicken', grams: 170 }, { ingredientId: 'potato', grams: 320 }, { ingredientId: 'broccoli', grams: 140 },
      { ingredientId: 'pepper', grams: 100 }, { ingredientId: 'oliveoil', grams: 10 },
    ],
  ...
  },
  {
    ...
    ingredients: [
      { ingredientId: 'turkey', grams: 180 }, { ingredientId: 'pasta', grams: 230 }, { ingredientId: 'spinach', grams: 100 },
      { ingredientId: 'tomato', grams: 140 }, { ingredientId: 'oliveoil', grams: 10 },
    ],
    steps: ['Cocina el pavo completamente.', 'Mezcla con la pasta cocida.', 'Añade espinaca, tomate y aceite.'],
  },
  {
    id: 'salmon-potato', name: 'Salmón con patata y ensalada', servings: 1, prepMinutes: 24,
    ingredients: [
      { ingredientId: 'salmon', grams: 160 }, { ingredientId: 'potato', grams: 300 }, { ingredientId: 'spinach', grams: 100 }, { ingredientId: 'tomato', grams: 150 },
    ],
    steps: ['Cocina el salmón hasta el punto seguro.', 'Prepara la patata.', 'Sirve con espinaca y tomate.'],
  },
  {
    id: 'lentil-chicken', name: 'Lentejas con pollo y verduras', servings: 1, prepMinutes: 18,
    ingredients: [
      { ingredientId: 'lentils', grams: 260 }, { ingredientId: 'chicken', grams: 120 }, { ingredientId: 'tomato', grams: 120 },
      { ingredientId: 'pepper', grams: 100 }, { ingredientId: 'oliveoil', grams: 8 },
    ],
    steps: ['Calienta las lentejas cocidas.', 'Añade pollo ya cocinado y las verduras.', 'Termina con el aceite de oliva.'],
  },
  {
    id: 'chickpea-tuna', name: 'Ensalada de garbanzos y atún', servings: 1, prepMinutes: 10,
    ingredients: [
      { ingredientId: 'chickpeas', grams: 220 }, { ingredientId: 'tuna', grams: 120 }, { ingredientId: 'tomato', grams: 150 },
      { ingredientId: 'spinach', grams: 80 }, { ingredientId: 'oliveoil', grams: 8 },
    ],
    steps: ['Enjuaga y escurre los garbanzos.', 'Mezcla con atún y verduras.', 'Aliña con el aceite al final.'],
  },
  {
    id: 'tuna-toast', name: 'Tostadas integrales con atún, aguacate y tomate', servings: 1, prepMinutes: 8,
    ingredients: [
      { ingredientId: 'bread', grams: 90 }, { ingredientId: 'tuna', grams: 120 }, { ingredientId: 'avocado', grams: 55 }, { ingredientId: 'tomato', grams: 150 },
    ],
    steps: ['Tuesta el pan.', 'Reparte el atún y el aguacate.', 'Añade el tomate.'],
  },
  {
    id: 'turkey-wrap', name: 'Wrap integral de pavo y aguacate', servings: 1, prepMinutes: 9,
    ingredients: [
      { ingredientId: 'wrap', grams: 75 }, { ingredientId: 'turkey', grams: 130 }, { ingredientId: 'avocado', grams: 45 },
      { ingredientId: 'tomato', grams: 100 }, { ingredientId: 'spinach', grams: 60 },
    ],
  ...
  },
  {
    ...
    ingredients: [
      { ingredientId: 'skyr', grams: 250 }, { ingredientId: 'banana', grams: 120 }, { ingredientId: 'almonds', grams: 15 },
    ],
    steps: ['Sirve el skyr.', 'Añade el plátano en rodajas.', 'Termina con almendras troceadas.'],
  },
];
