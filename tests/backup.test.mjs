...
const valid = {
  ...
  local: {
    ...
    fitcoach_nutrition_profile_v34: { sex: 'm', age: 46, height: 181, weight: 81, bodyFat: 22, activity: 1.6, goal: 'recomp', equation: 'mifflin' }
  },
  photos: [{
    id: 'p1',
    date: '2026-08-11',
...
assert.equal(STORAGE_KEYS.includes('fitcoach_nutrition_profile_v34'), true);
