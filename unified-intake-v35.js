  ...
  function formMarkup(p) {
    ...
    return `
      ...
      <section class="fcStep active" data-step="0"><h3>1 · Persona y objetivo</h3>
        ...
        <div class="fcGrid3"><label>Altura cm<input id="fcHeight" type="number" value="${p.height||170}"></label><label>Peso kg<input id="fcWeight" type="number" step="0.1" value="${p.weight||70}"></label><label>Grasa % opcional<input id="fcBodyFat" type="number" step="0.1" value="${p.bodyFat??''}"></label></div>
